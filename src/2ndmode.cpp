...
void secondMode()
{
    ...
    //render obstacle
    SDL_RenderCopy(gRenderer,spirit,&spirit_spriteclips[enemy[SPIRIT].speed++],&enemy[SPIRIT].body);
    ...
    render(Man,mWidth,mHeight,x_pos,y_pos+260,currentclip);

    //Render star
    render(knife_texture,60,60,star.x,star.y+280,NULL);
